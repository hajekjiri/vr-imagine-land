...
function initExhibits(userRig){
    ...
    //scene.add(new Ferris(animatedObjects,userRig,1,false,12)); 
    //scene.add(new Range(renderer.xr,animatedObjects,userRig,4,4,4,4)); 
    
    var range1 = new Range(renderer.xr,animatedObjects,userRig,1,8,8,8);
    range1.position.set(-8,0,-10);
    range1.rotation.set(0,Math.PI/8,0);
    scene.add(range1);
    var range2 = new Range(renderer.xr,animatedObjects,userRig,4,4,4,4); 
    range2.position.set(0,0,-10);
    scene.add(range2);
    var range3 = new Range(renderer.xr,animatedObjects,userRig,10,1,4,4); 
    range3.position.set(8,0,-10);
    range3.rotation.set(0,-Math.PI/8,0);
    scene.add(range3);
    
    var ferris1=new Ferris(animatedObjects,userRig,5,true,4); 
    ferris1.position.set(0,0,10);
    ferris1.rotation.set(0,-Math.PI,0);
    scene.add(ferris1);
    
    var ferris2=new Ferris(animatedObjects,userRig,3,true,12); 
    ferris2.position.set(10,0,10);
    ferris2.rotation.set(0,-Math.PI,0);
    scene.add(ferris2);
    
    var ferris3=new Ferris(animatedObjects,userRig,1,true,24); 
    ferris3.rotation.set(0,-Math.PI,0);
    ferris3.position.set(-10,0,10);
    scene.add(ferris3);
}
