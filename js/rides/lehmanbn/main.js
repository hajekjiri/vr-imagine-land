...
import * as SWASH from './SixFlagsSwashbuckler.js';
...
function initExhibits(userRig){
    ...
    */
    var swash1 = new SWASH.Swashbuckler(userRig, animatedObjects, 0, 2, 10);
    scene.add(swash1);

    var swash2 = new SWASH.Swashbuckler(userRig, animatedObjects, 2, 4, 15);
    scene.add(swash2);
    swash2.position.z = -25;

    var swash3 = new SWASH.Swashbuckler(userRig, animatedObjects, 7, 9, 30);
    scene.add(swash3);
    swash3.position.z = -45;


    var toss1 = new TOSS.Toss(userRig, animatedObjects,2,2,5);
    scene.add(toss1);

    var toss2 = new TOSS.Toss(userRig, animatedObjects,2,2,10);
    scene.add(toss2);
    toss2.position.z = -25;

    var toss3 = new TOSS.Toss(userRig, animatedObjects,2,2,15);
    scene.add(toss3);
    toss3.position.z = -45;
