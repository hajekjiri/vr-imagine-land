...
import * as RIDE from './TeacupRide.js';
import * as GAME from './BalloonDarts.js';
...
function initTeacupRide(userRig){
    var tRide1 = new RIDE.teacupRide(userRig, 5, 4, .5);
    tRide1.position.x = -6;
    tRide1.position.y = 0;
    tRide1.position.z = 0;
    var sign1 = tRide1.makeButton();
    sign1.position.x = -6;
    sign1.position.y = 1;
    sign1.position.z = -5;
    animatedObjects.push(tRide1);
    scene.add(tRide1);
    scene.add(sign1);

/*    var tRide2 = new RIDE.teacupRide(userRig, 7, 6, 4);
    tRide2.position.x = 0;
    tRide2.position.y = 0;
    tRide2.position.z = -15;
    var sign2 = tRide2.makeButton();
    sign2.position.x = 0;
    sign2.position.y = 1;
    sign2.position.z = -15;
    animatedObjects.push(tRide2);
    scene.add(tRide2);
    scene.add(sign2);

    var tRide3 = new RIDE.teacupRide(userRig, 4, 3, 2);
    tRide3.position.x = 4;
    tRide3.position.y = 0;
    tRide3.position.z = 0;
    var sign3 = tRide3.makeButton();
    sign3.position.x = 0;
    sign3.position.y = 1;
    sign3.position.z = -5;
    animatedObjects.push(tRide3);
    scene.add(tRide3);
    scene.add(sign3);*/
}

function initCarnivalGame(userRig){
    var game1 = new GAME.balloonDartGame(userRig, 12, .5);
    game1.position.x = -12;
    game1.position.y = 0;
    game1.position.z = -8;
    ...
    // var game2 = new GAME.balloonDartGame(userRig, 15, 1);
    // game2.position.x = 12;
    // game2.position.y = 0;
    // game2.position.z = -15;
    ...
    // var game3 = new GAME.balloonDartGame(userRig, 6, 0);
    // game3.position.x = 12;
    // game3.position.y = 0;
    // game3.position.z = -5;
...
function initExhibits(userRig){
    ...
    //initTeacupRide(userRig);
    initCarnivalGame(userRig);
}
