...
import * as WHACKEMALL from './WhackEmAll.js'
...
function initExhibits(userRig){
    ...
    let carousel1 = new CAROUSEL.Carousel(userRig, -2,0,-18, 0,30,0, scene, animatedObjects, 1, 1, 0, "Krazy Karusel");
    let carousel2 = new CAROUSEL.Carousel(userRig, -3,0,-12, 0,45,0, scene, animatedObjects, -5, 0, 0, "Krazier Karusel");
    let carousel3 = new CAROUSEL.Carousel(userRig, -4,0,-6, 0,60,0, scene, animatedObjects, 7, 2, 2, "Kraziest Karusel");
    let whackemall1 = new WHACKEMALL.WhackEmAll(userRig, 2, 0, -18, 0,-30,0, scene, animatedObjects, 3, 1, 1, "Jumpy Boys!");
    let whackemall2 = new WHACKEMALL.WhackEmAll(userRig,  3, 0,-12, 0,-45,0, scene, animatedObjects, 1, 1, 2, "Whack Em All!");
    let whackemall3 = new WHACKEMALL.WhackEmAll(userRig, 4, 0, -6, 0,-60,0, scene, animatedObjects, 0, 2, 3, "Hiding Moles!");
}
