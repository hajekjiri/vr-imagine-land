...
import * as SKYSCREAMER from './SkyScreamer.js'
import * as MOUNTAIN from './MountainClimb.js'
...
function initExhibitSkyScreamer(userRig)
{
    var skyscreamer = new SKYSCREAMER.SkyScreamer(userRig);
    animatedObjects.push(skyscreamer);
    scene.add(skyscreamer);
    
    var skyscreamer2 = new SKYSCREAMER.SkyScreamer(userRig, 10);
    animatedObjects.push(skyscreamer2);
    skyscreamer.position.x = 10;
    scene.add(skyscreamer2);
}

function initExhibitMountainClimb(userRig){
  var mountainClimb = new MOUNTAIN.MountainClimb(userRig);
  mountainClimb.position.x = 6;
  animatedObjects.push(mountainClimb);
  scene.add(mountainClimb);
  var mountainClimb1 = new MOUNTAIN.MountainClimb(userRig,4);
  mountainClimb1.position.x = -6;
  animatedObjects.push(mountainClimb1);
  scene.add(mountainClimb1);
  var mountainClimb2 = new MOUNTAIN.MountainClimb(userRig,2);
  mountainClimb2.position.z = 40;
  animatedObjects.push(mountainClimb2);
  scene.add(mountainClimb2);
}
...
function initExhibits(userRig){
    ...
    */
    //initExhibit2(userRig);
    initExhibitSkyScreamer(userRig);
    initExhibitMountainClimb(userRig);
}
