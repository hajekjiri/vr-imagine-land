...
function initCarnivalCup(userRig,scale){
  var carnivalCup = new RIDE.carnivalCup(userRig,scale);
  animatedObjects.push(carnivalCup);
  scene.add(carnivalCup);
}

function initCarnivalCross(userRig,scale){

  var carnivalCross = new GAME.carnivalCross(userRig,scale);
  animatedObjects.push(carnivalCross);
  scene.add(carnivalCross);
...
function initExhibits(userRig){
    ...
    //initCarnivalCup(userRig,1);
    initCarnivalCross(userRig,1);
}
