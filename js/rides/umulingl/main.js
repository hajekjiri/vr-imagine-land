...
{
  //shooting game
  //set the size,speed in this order
  var g1=new GAME.GameB(userRig,0.5,0.01);
  g1.position.x=-1;
  g1.position.z=-5;
  g1.rotation.y=-90;
  animatedObjects.push(g1);
  scene.add(g1);

  //
  var g2=new GAME.GameB(userRig,2,3);
  g2.position.x=-5;
  g2.position.z=-5;
  animatedObjects.push(g2);
  scene.add(g2);

  //
  var g3=new GAME.GameB(userRig,5,9);
  g3.position.x=-10;
  g3.position.z=-5;
  g3.rotation.y=90;
  animatedObjects.push(g3);
  scene.add(g3);
...
function initExhibit6(userRig)
{
  ...
  // first ride --small
  var ride1=new RIDE.Ride(userRig,0.1,1);
  ride1.position.x=2; //0
  ride1.position.z=-17;
  //ride1.position.z=-20;
  ...
  //second ride -- medium
  var ride2=new RIDE.Ride(userRig,3,3);
  ride2.position.x=-3;
  ride2.position.z=-31;
  ...
  //third ride --large
  var ride3=new RIDE.Ride(userRig,5,5);
  ride3.position.x=8;
  ride3.position.z=-31;
