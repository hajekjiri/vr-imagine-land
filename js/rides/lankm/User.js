...
class BaseUserPlatform extends GUIVR.GuiVR {
    constructor(userRig, onLand, onLeave, name="platform") {
        super();
    ...
    collide(uv, pt) {
        ...
        if (parent !== undefined && (parent instanceof BaseUserPlatform)) {
...
export class UserPlatform extends BaseUserPlatform {

    constructor(userRig, onLand, onLeave, name) {
        super(userRig, onLand, onLeave, name);
...
export class CupPlatform extends BaseUserPlatform {

    constructor(userRig, cup, onLand, onLeave) {
        super(userRig, onLand, onLeave);
        this.collider = cup.children[0].children[0].children[1];
        this.add(cup);
    }

    collide(uv, pt) {
        super.collide(uv, pt);
        this.userRig.position.y = -1; // move user camera down to seat
        this.userRig.position.z = .2 ; // move him closer to center of cup
    }
}
