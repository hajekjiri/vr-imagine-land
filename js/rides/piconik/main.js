...
//import {OBJLoader} from "../extern/jsm/loaders/OBJLoader";
...
//import {initRide} from "./Ride";
//import './15188_Spinning_Teacup_v1_NEW.obj';
...
function initExhibits(userRig){
    ...
    //var r1 = new RIDE.Ride(userRig,scene, animatedObjects, 1,1,1, new Array(0,0,-10));
    //var r2 = new RIDE.Ride(userRig,scene, animatedObjects, 4,4,4, new Array(0,0,4));
    //var r3 = new RIDE.Ride(userRig,scene, animatedObjects, 1,4,8, new Array(10,0,4));
    
    var g1 = new GAME.Game(userRig, renderer.xr, scene,animatedObjects, 2, new Array(-10,0,-4));
    var g2 = new GAME.Game(userRig, renderer.xr, scene,animatedObjects, 1, new Array(0,0,-4));
    var g3 = new GAME.Game(userRig, renderer.xr, scene,animatedObjects, 3, new Array(10,0,-4));
    //var g = new GAME.Game(userRig, renderer.xr, scene,animatedObjects, 1, new Array(0,0,-4));
    //var r = new RIDE;
    //r.initRide(userRig,animatedObjects, scene)
}
...
// https://encycolorpedia.com/f4ff62
//https://pixabay.com/photos/bricks-wall-stones-structure-459299/
//https://cs.wellesley.edu/~cs307/lectures/10new.html
//https://threejs.org/docs/#api/en/core/Object3D.getWorldPosition
//https://github.com/mrdoob/three.js/issues/13696
